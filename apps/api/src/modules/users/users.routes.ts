...
export async function usersRoutes(app: FastifyInstance) {
  ...
  app.post("/users",   { preHandler: [requireAuth, requireLicense, requirePermission("users.create")] }, controller.create);
  app.patch("/users/:id",{ preHandler:[requireAuth, requireLicense, requirePermission("users.update")] }, controller.update);

  app.get("/users/:id/roles", { preHandler: [requireAuth, requirePermission("users.read")] }, controller.roles);
  app.put("/users/:id/roles",{ preHandler:[requireAuth, requireLicense, requirePermission("users.update")] }, controller.setRoles);
  ...
  app.post("/users/link",{ preHandler:[requireAuth, requireLicense, requirePermission("users.create")] }, controller.link);
