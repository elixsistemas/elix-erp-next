...
export async function listCostCenters(args: ListArgs) {
...
export async function getCostCenter(companyId: number, id: number) {
  const pool = await getPool();
...
export async function createCostCenter(args: CreateArgs) {
  const pool = await getPool();
...
export async function updateCostCenter(args: UpdateArgs) {
  const pool = await getPool();
...
export async function existsCostCenterByCode(
  companyId: number,
  code: string,
  ignoreId?: number,
) {
...
export async function removeCostCenter(companyId: number, id: number) {
  const pool = await getPool();
