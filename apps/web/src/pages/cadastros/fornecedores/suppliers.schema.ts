...
export type SupplierUpsertForm = z.infer<typeof SupplierUpsertSchema>;

export const supplierFormSchema = SupplierUpsertSchema;
export type SupplierFormValues = SupplierUpsertForm;